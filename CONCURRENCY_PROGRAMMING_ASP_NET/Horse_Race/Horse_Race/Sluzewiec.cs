    ...
    class Sluzewiec
    {
		...
		*/
		...
		private void Initialize_Horse_Participants()
		{
			...
			Horse_Participants[0] = new Horse("Mark 1",Get_Random_Value(1,5));
			Horse_Participants[1] = new Horse("Henry 2", Get_Random_Value(1, 3));
			Horse_Participants[2] = new Horse("Peter 3", Get_Random_Value(1, 4));
			Horse_Participants[3] = new Horse("Oliver 4", Get_Random_Value(1, 5));
			Horse_Participants[4] = new Horse("Marcus 5", Get_Random_Value(1, 2));
		}
